  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      ...
      <div className="space-x-3">
        <button type="button" className="text-sm font-medium text-violet-500 dark:text-violet-300 dark:hover:text-violet-200">Dismiss</button>
        <button type="button" className="text-sm font-medium text-violet-700 dark:text-zinc-300 dark:hover:text-zinc-100">Upgrade plan</button>
      </div>
    </div>
  )
}
